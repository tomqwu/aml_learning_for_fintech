...
| Business Analyst | 1. [`docs/01`](docs/01-aml-transaction-monitoring-foundations.md) 2. [`docs/03`](docs/03-rule-migration-spec-as-code.md) 3. [`docs/19`](docs/19-role-business-analyst.md) 4. the amount-drift case study and evidence-pack sections of [`docs/04`](docs/04-data-quality-reconciliation-defect-management.md) 5. [`docs/17`](docs/17-project-scope-call-prep.md) | read the notebook explanation cells for Steps 4, 8, and Appendices C-D and predict outputs - no coding required | drills inside each guide, then [`docs/06`](docs/06-practice-lab-retrieval-tests.md) |
...
| Business analyst / MBA / product-strategy | doc 18, section 3.6 | the Business Analyst role guide [`docs/19-role-business-analyst.md`](docs/19-role-business-analyst.md), then rule specs in [`docs/03-rule-migration-spec-as-code.md`](docs/03-rule-migration-spec-as-code.md) |
